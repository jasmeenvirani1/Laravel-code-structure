...
use App\Models\FitnessGoal as Model; // FitnessGoal know as a Model.
...
class FitnessGoalController extends Controller
{
    ...
    {
        $this->modual_name = 'FitnessGoal';
        $this->title = 'Fitness Goal';
        $this->view = 'backend.fitness-goal.';
    ...
    public function FetchFitnessGoal(Request $request)
    {
    ...
    {
        $keyword_detail = Model::where('id', $request->id)->get(['id','name']);

        return response()->json([
            'status' => 200,
            'message' => 'Fitness goal detail loaded successfully',
    ...
    public function Update(Request $request)
    {
        ...
        return response()->json([
            'status' => 200,
            'message' => 'Fitness goal Update succesfully',
        ]);
    }
    ...
    public function Delete(Request $request)
    {
        ...
        return response()->json([
            'status' => 200,
            'message' => 'Fitness goal Deleted succesfully',
        ]);
    }
