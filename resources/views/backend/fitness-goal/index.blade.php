                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" placeholder="Enter fitness goal name" name="name">
...
@section('page-script')
    <script>
        ...
        function fetchFitnessGoalData() {
            $('#selection-datatable').DataTable({
                ...
                "ajax": "{{ route('admin.fitness-goal.fetch') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
    ...
    <script>
        ...
        $("#add" + ucword_modual_name + "Form").submit(function(event) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('admin.fitness-goal.store') }}",
                data: formData,
                dataType: "json",
                contentType: false,
                processData: false,
                success: function(response) {
                    ...
                    if (response.status == 400) {
                        ...
                        $(".add-user-submit-btn").text('Add Fitness goal');
                    } else if (response.status == 200) {

                        // Showing Success Message
                        triggerNotification('The fitness goal has been added');
    ...
    <script>
        ...
        $(document).on("click", ".edit-" + modual_name + "", function() {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('admin.fitness-goal.edit') }}",
                data: formData,
                dataType: "json",
                contentType: false,
                processData: false,
        ...
        $("#edit" + ucword_modual_name + "Form").submit(function(event) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('admin.fitness-goal.update') }}",
                data: formData,
                dataType: "json",
                contentType: false,
                processData: false,
        ...
        $(document).on("click", ".delete-" + modual_name + "", function() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ route('admin.fitness-goal.delete') }}",
                        data: formData,
                        dataType: "json",
                        processData: false,
                        contentType: false,
                        success: function(response) {
                            if (response.status == 200) {
                                ...
                                triggerNotification(
                                    'The fitness goal has been deleted.');
        ...
        function ChangeStatus(questionId, status) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ route('admin.fitness-goal.change_status') }}",
                        data: formData,
                        dataType: "json",
                        processData: false,
                        contentType: false,
                        success: function(response) {
                            if (response.status == 200) {
                                if (status == 1) {
                                    triggerNotification("The fitness goal activated successfully");
                                } else {
                                    triggerNotification("The fitness goal inactivat successfully");
                                }
                                fetchFitnessGoalData();
                            }
                        },
